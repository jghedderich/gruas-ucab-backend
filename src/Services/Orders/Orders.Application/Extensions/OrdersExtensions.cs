...
public static class OrderExtensions
{
    public static IEnumerable<OrderDto> ToOrderDtoList(this IEnumerable<Order> orders)
    {
        return orders.Select(o => new OrderDto(
                ...
                new AddressDto(o.IncidentAddress.AddressLine1, o.IncidentAddress.AddressLine2, o.IncidentAddress.City, o.IncidentAddress.State, o.IncidentAddress.Zip, o.IncidentAddress.Latitude, o.IncidentAddress.Longitude),
                new AddressDto(o.DestinationAddress.AddressLine1, o.DestinationAddress.AddressLine2, o.DestinationAddress.City, o.DestinationAddress.State, o.DestinationAddress.Zip, o.DestinationAddress.Latitude, o.DestinationAddress.Longitude),
    ...
    private static OrderDto DtoFromOrder(Order order)
    {
        return new OrderDto(
                ...
                new AddressDto(order.IncidentAddress.AddressLine1, order.IncidentAddress.AddressLine2, order.IncidentAddress.City, order.IncidentAddress.State, order.IncidentAddress.Zip, order.IncidentAddress.Latitude, order.IncidentAddress.Longitude),
                new AddressDto(order.DestinationAddress.AddressLine1, order.DestinationAddress.AddressLine2, order.DestinationAddress.City, order.DestinationAddress.State, order.DestinationAddress.Zip, order.DestinationAddress.Latitude, order.DestinationAddress.Longitude),
