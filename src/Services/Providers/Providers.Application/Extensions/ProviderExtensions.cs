...
public static class ProviderExtensions
{
    public static IEnumerable<ProviderDto> ToProviderDtoList(this IEnumerable<Provider> providers)
    {
        return providers.Select(p => new ProviderDto(
            ...
            Company: new CompanyDto(
                ...
                p.Company.State, 
                p.Company.City),
            Vehicles: p.Vehicles.Select(v => new VehicleDto(v.Id, v.Type.ToString(), v.Brand.Value, v.Model.Value, v.Year)).ToList(),
    ...
    private static ProviderDto DtoFromProvider(Provider provider)
    {
        return new ProviderDto(
                ...
                Vehicles: provider.Vehicles.Select(v => new VehicleDto(v.Id, v.Type.ToString(), v.Brand.Value, v.Model.Value, v.Year)).ToList(),
